...
A recent focus of my work is DeepPolaron, a machine learning approach to modelling small polaron transport. The methodology is described in a [preprint on arXiv](https://arxiv.org/abs/2606.01763), with an implementation currently being integrated into [DeePMD-kit](https://github.com/deepmodeling/deepmd-kit).
